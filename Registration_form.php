...
-->
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="ownership" placeholder="Advertisement Ownership">
				</div>
				<div class="form-group">
				...
				<div class="form-group">	
					...
					<input class="form-control" type="number" min="1" max="15" name="page_specifications" placeholder="(Which page you want the ad to be posted in ?)">
				</div>
				<div class="row">
				<div class="form-group">
